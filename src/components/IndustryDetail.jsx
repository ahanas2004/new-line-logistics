...
export default function IndustryDetail({ icon, title, subtitle, description, challenges, solutions, stats, img }) {
  return (
    <div className="industry-detail-page">

      {/* ── Page Hero ── */}
      <div className="page-hero id-hero" style={{ backgroundImage: `url(${img})` }}>
